"""Predicted 5s goal on per-command anchors (lateral splits where train support allows). Submittable.

VADLAW_etri_tiny_clean_nodistill.py + goal_pred with _goal_anchors_pair_adaptive.py.
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
             init_kwargs=dict(project='etri-2026-e2e-vad',
                              name='stage2_goalanchors_adaptive_v1 (TP-select loss)')),
    ])

...
class VAD(MVXTwoStageDetector):
    ...
    def forward_train(self,
        ...
        # for the current (gradient-enabled) frame.  That silently prevents
        # gradients from reaching the backbone, FPN, TSA, and encoder FFN.
        if len_queue > 1:
    ...
    def forward_test(
        ...
        **kwargs
        ...
        new_prev_bev, bbox_results = self.simple_test(
            ...
            ego_target_point=(
                ego_target_point[0] if ego_target_point is not None else None),
            gt_attr_labels=gt_attr_labels,
            **kwargs
        )

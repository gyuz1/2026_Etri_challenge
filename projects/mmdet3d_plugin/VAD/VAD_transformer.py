...
class VADPerceptionTransformer(BaseModule):
    ...
    def get_bev_features(
        ...
        # np.array(...) first, then a single new_tensor() call -- PyTorch's
        # own warning flags list-of-ndarrays -> tensor as "extremely slow"
        # (a slow per-element Python loop internally); bulk-stacking first
        # takes the fast path to a numerically identical tensor.

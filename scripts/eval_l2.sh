#!/usr/bin/env bash
# 사용법: [EVAL_GPU=0] ./scripts/eval_l2.sh <student-clean|nodistill-clean|goalpred-clean|teacher|student|nodistill|nodrop|A:student> [epoch] [플래그...]
#
...
case "$TARGET" in
  ...
  *) echo "사용법: $0 <student-clean|nodistill-clean|goalpred-clean|teacher|student|nodistill|nodrop|A:student> [epoch] [플래그...]" >&2
     exit 1 ;;
esac
